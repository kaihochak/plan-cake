      ...
      <div className='h-screen pt-6 overflow-hidden lg:ml-20 lg:grid lg:grid-cols-5'>
        ...
        {loading ?
          ...
          <div className='relative flex-center lg:col-span-3 '>
            <div className='w-[350px] sm:w-[380px] md:w-[350px] mx-auto lg:w-[724px] '>
              {/* film 1 */}
              <img
              ...
              <img
                ...
                alt={trending && trending[0]?.title}
                className='rounded-sm absolute w-[150px] rotate-[-10deg] top-1/2 translate-x-[80%] translate-y-[3%] z-50 lg:z-30 lg:w-[180px] lg:translate-x-[100%] lg:rotate-[10deg] lg:translate-y-[-50%]'
              />
              <img
                src={trending && trending[0]?.poster_path ? image500(trending[2].poster_path) : fallbackMoviePoster}
                alt={trending && trending[0]?.title}
                className='rounded-sm absolute w-[150px] rotate-[15deg] top-1/2 translate-x-[150%] translate-y-[25%] z-40 lg:z-40 lg:w-[190px] lg:translate-x-[140%] lg:rotate-[-5deg] lg:translate-y-[-50%]'
              />
              <img
                src={trending && trending[0]?.poster_path ? image500(trending[3].poster_path) : fallbackMoviePoster}
                alt={trending && trending[0]?.title}
                className='rounded-sm absolute w-[150px] rotate-[-15deg] top-1/2 translate-x-[30%] translate-y-[80%] z-40 lg:z-50 lg:w-[180px] lg:translate-x-[210%] lg:rotate-[10deg] lg:translate-y-[-50%]'
              />
              <img
                src={trending && trending[0]?.poster_path ? image500(trending[4].poster_path) : fallbackMoviePoster}
                alt={trending && trending[0]?.title}
                className='rounded-sm absolute w-[150px] rotate-[15deg] top-1/2 translate-x-[90%] translate-y-[80%] z-30 lg:z-50 lg:w-[190px] lg:translate-x-[260%] lg:rotate-[-15deg] lg:translate-y-[-50%]'
              />
            </div>
          </div>
        }
