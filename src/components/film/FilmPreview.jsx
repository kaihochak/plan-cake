...
const FilmPreview = ({ filmId, isModalOpen, setIsModalOpen }) => {
	...
	const FilmDesc = () => {
		return (
			...
			{/* title */}
			<h1 className="h3 ">{film?.original_title}</h1>
	...
	const FilmInfo = () => {
		return (
			<div className='flex flex-col max-w-[1024px] w-full h-full'>
				...
				<div className='flex flex-col justify-center items-center gap-4 md:flex-row lg:gap-10'>
					...
					<div className='justify-start p-6 '>
						{! loading ? (
							...
							<div>
								<Skeleton className="bg-primary-light w-[250px] h-[350px] rounded-2xl" />
							</div>
						)
						}
					</div>
					...
					{! loading ? 
						<FilmDesc /> : 
						<div className='flex flex-col justify-center al gap-2 lg:gap-4'>
							<Skeleton className="bg-primary-light w-[280px] h-[40px] rounded-2xl" />
							<Skeleton className="bg-primary-light w-[280px] h-[20px] rounded-2xl" />
							<Skeleton className="bg-primary-light w-[280px] h-[120px] rounded-2xl" />
							<Skeleton className="bg-primary-light w-[280px] h-[50px] rounded-2xl" />
							<Skeleton className="bg-primary-light w-[280px] h-[20px] rounded-2xl" />
						</div> 
					}
				</div>
	...
	******************************************************************/
	...
	return (
		<Dialog open={isModalOpen} onOpenChange={setIsModalOpen}>
			{/* Content */}
			<DialogContent className="bg-primary text-secondary max-w-[1024px] w-full h-fit lg:w-[75%] overflow-scroll md:overflow-hidden">
				<div>
					{/* Film Info */}
						<FilmInfo />
				</div>
